              ...
              <?php } ?>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right">
                    ...
                    <a class="dropdown-item" href="order.php"><i class="fas fa-calendar-week"></i> Pending Orders</a>
                  </div>
                </div>
              </li>
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="../img/logo.jpeg" alt="avatar"><i></i></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="../img/logo.jpeg" alt="avatar"><span class="user-name text-bold-700 ml-1"><?php echo $_SESSION['username'] ?></span></span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#exampleModalPassChange"><i class="ft-user"></i> Change Password</a>
                    <a class="dropdown-item" href="message.php"><i class="ft-mail"></i> My Inbox</a>
